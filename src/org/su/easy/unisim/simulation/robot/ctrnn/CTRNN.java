...
public class CTRNN implements IRobotController{
    ...
    public CTRNN(RobotGenotype g, ExpParam params) {
        ...
        ArrayList<org.su.easy.unisim.simulation.robot.ctrnn.Neuron> neurs = g.layout.getAllNeurons();
        for(int i = 0; i < n; i++) {
            org.su.easy.unisim.simulation.robot.ctrnn.Neuron neuron = neurs.get(i);
