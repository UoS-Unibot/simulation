...
import org.su.easy.unisim.simulation.robot.ctrnn.CTRNNParamRanges;
import org.su.easy.unisim.simulation.robot.ctrnn.LayoutBuilder;
...
public class JSONCTRNNLayout {
    ...
    public CTRNNLayout toCTRNNLayout() {
        ...
        HashMap<org.su.easy.unisim.simulation.robot.ctrnn.Neuron, ArrayList<String>> conns = new HashMap<>();
        int idCount = 0;
        for (Layer l : layers) {
            lb.addNewLayer();
            ...
            for (Neuron n : l.getNeurons()) {
                org.su.easy.unisim.simulation.robot.ctrnn.Neuron neuron = new org.su.easy.unisim.simulation.robot.ctrnn.Neuron(idCount);
        ...
        for (org.su.easy.unisim.simulation.robot.ctrnn.Neuron neuron : conns.keySet()) {
            for(String conn : conns.get(neuron)) {
                org.su.easy.unisim.simulation.robot.ctrnn.Neuron neuron2 = lb.getNeuronByName(conn);
                if(neuron2 == null)
    ...
    public org.su.easy.unisim.simulation.robot.ctrnn.jsonIO.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(org.su.easy.unisim.simulation.robot.ctrnn.jsonIO.Metadata metadata) {
