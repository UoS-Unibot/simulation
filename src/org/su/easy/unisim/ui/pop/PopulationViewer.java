...
import org.su.easy.unisim.ui.TrialViewerFrame;
        ...
        miTrial.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    tvf.loadSimulation(Experiment.fromDirectory(new File(pop.filename).getParent()), ((PopulationTM)jTable1.getModel()).getPop().getGenotypeAt(jTable1.getSelectedRow()));
                    getParent().add(tvf);
